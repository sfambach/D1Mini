 ...
 *
 * https://github.com/wemos/LOLIN_I2C_MOTOR_Library/blob/master/examples/simple/simple.ino
*/
...
void loop()
{
  ...
  motor.changeFreq(MOTOR_CH_BOTH, 10000); //Change A & B 's Frequency to 1000Hz.
  /*
